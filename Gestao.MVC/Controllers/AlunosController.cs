...
namespace CadastroDeAlunos.Controllers
{
    ...
    public class AlunosController : Controller
    {
        ...
        //{
        //    IQueryable<CidadesViewModel> cidade = db.CidadesViewModel;
        //    if (!string.IsNullOrEmpty(searchString))
        //    {
        //        if (coluna == "Codigo")
        //        {
        ...
        //    }
        //    PessoasViewModel pessoas = await db.PessoViewModel.FindAsync(id);
        //    if (pessoas == null)
        //    {
        //        return HttpNotFound();
        //    }
        ...
        //public async Task<ActionResult> CreatePai([Bind(Include = "id,idPessoa,idTpoPessoa,idUsuarioUpdate,Nome,Rg,Cpf,DataNascimento,Matricula,Idade,Sexo,Profissao,DataCadastro,DataAlteração,Telefone,Celular1,Celular2,Logradouro,Numero,Bairro,Complemento,Cidade,Estado,Cep")] PessoasViewModel pessoas)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> CreateMae([Bind(Include = "id,idPessoa,idTpoPessoa,idUsuarioUpdate,Nome,Rg,Cpf,DataNascimento,Matricula,Idade,Sexo,Profissao,DataCadastro,DataAlteração,Telefone,Celular1,Celular2,Logradouro,Numero,Bairro,Complemento,Cidade,Estado,Cep")] PessoasViewModel pessoas)
        //{
        //    if (ModelState.IsValid)
        //    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> Create([Bind(Include = "id,idPessoa,idTpoPessoa,idUsuarioUpdate,Nome,Rg,Cpf,DataNascimento,Matricula,Idade,Sexo,Profissao,DataCadastro,DataAlteração,Telefone,Celular1,Celular2,Logradouro,Numero,Bairro,Complemento,Cidade,Estado,Cep")] PessoasViewModel pessoas)
        //{
        //    if (ModelState.IsValid)
        //    {
        ...
        //    if (cidade > 0)
        //    {
        //        //var cidadeModel = new CidadesController()
        //        //{
        ...
        //        return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        //    }
        //    PessoasViewModel pessoas = await db.Pessoas.FindAsync(id);
        //    if (pessoas == null)
        //    {
        //        return HttpNotFound();
        //    }
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> Edit([Bind(Include = "id,idPessoa,idTpoPessoa,idUsuarioUpdate,Nome,Rg,Cpf,DataNascimento,Matricula,Idade,Sexo,Profissao,DataCadastro,DataAlteração,Telefone,Celular1,Celular2,Logradouro,Numero,Bairro,Complemento,Cidade,Estado,Cep")] PessoasViewModel pessoas)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        pessoas.idUsuarioUpdate = User.Identity.GetUserId();
